...
\begin{titlepage}
 \vspace*{\fill}
	\begin{center}
    	\begin{figure}
			\includegraphics[width = 65mm]{Engineering}
		\end{figure}
		{\Large Fourth Year Project Report} \vspace{0.25cm}
		\rule{\textwidth}{.1pt} \\[0.25cm]
		{\Huge Relay Feedback Models of Biological Oscillators}\\%[0.5cm]
...
\begin{figure}[h!]
\includegraphics[width=0.8\textwidth]{parameter_space}
...
Setting $b_1 = b_2 = b_3 = 1$ (for simplicity) and rewriting the equations such that the linear equations form the plant and the nonlinearity is a relay, results in the system shown in Figure \ref{goodwin_transfer} with the state space realisation: 
...
\begin{align}
\epsilon\rightarrow0\Rightarrow0 &= f(v) -w + I_{\text{app}}\\
...
\begin{figure}[h!]
\includegraphics[width = 0.4\textwidth]{feedback_interactions}
...
\begin{figure}[h!]
\includegraphics[width = 0.4\textwidth]{winged_cusp_phase_portrait}
...
\begin{figure}[h!]
\includegraphics[width=0.5\textwidth]{bump}
...
\begin{figure}[p]
\includegraphics[width = 0.45\textwidth]{tanh_and_saturation}
...
\begin{figure}[p]
\includegraphics[width = 0.45\textwidth]{bump_piece_bump}
...
\begin{figure}[p]
\includegraphics[width = 0.45\textwidth]{linearised_phase_portrait}
...
\resizebox{12cm}{!}{%
  ...
  \begin{tikzpicture}[auto, node distance=2cm,>=latex,scale=1]
      ...
      \node [block, below of = relay] (Hus) {\large $H_{u}$};
...
\begin{figure}
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\textwidth]{slow_xus}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\textwidth]{slow_xus_alone}
...
%\caption{Prediction of the duty cycle of the spiking oscillations changing with the ultra slow variable using the theory of asymmetric oscillations in relay feedback systems. As the ultra-slow variable increases, the duty cycle changes. This matches the simulation results shown in Figure \ref{fig:bursting_step3.1}.
...
\begin{figure}[tbp]
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\textwidth]{TAndTauForBursting}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\textwidth]{ultra_slow_hysteresis2}
...
\begin{figure}
\includegraphics[width = 0.9\textwidth]{duty_cycle}
...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \includegraphics[width=\textwidth]{shifting_hysteresis}
    ...
    \begin{subfigure}[t]{0.7\textwidth}
        \includegraphics[width=\textwidth]{changing_relay_output3}
...
\resizebox{9cm}{!}{%
  ...
  \begin{tikzpicture}[auto, node distance=2cm,>=latex,scale=0.75]
      ...
      \node [block, left of = ultra_slow_sum, node distance = 2cm] (Hus){\large $H_{u}$};
...
\begin{scope}[xscale = -1,xshift=0cm]
  ...
  \end{scope}
\end{tikzpicture}
\caption{Nonlinearity in new coordinates, $f_3(\cdot)$}
\end{subfigure}
      \caption{Shift coordinate system to make relay symmetric, $I_{app}$ disappears. $\hat{w} = w + \beta_2$ and $\hat{v} = v + \beta_1$}%
      \label{shift1}%
\end{figure}\nopagebreak%
\begin{figure}[h!]
\RawFloats
